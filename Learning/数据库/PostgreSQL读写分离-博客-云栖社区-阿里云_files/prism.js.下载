/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+apacheconf+aspnet+bash+basic+c+csharp+cpp+coffeescript+css-extras+go+java+less+lua+makefile+markdown+nginx+objectivec+pascal+perl+php+php-extras+python+smarty+sql+swift+vim&plugins=line-highlight+line-numbers+previewer-base */
